...
public class HardPlaying extends Activity implements View.OnClickListener {

    final static long INTERVAL = 920;
    ...
    ArrayList <QuestionHard> ranListQuesHard = new ArrayList<>();
    ...
    public void onClick(View view) {
        ...
        if (index < totalQuestion){
            ...
            if (clickedButton.getText().equals(ranListQuesHard.get(index).getCorrectAnswer())){
    ...
    private void showQuestion(int index) {
        if (index < 10){
            ...
            if (ranListQuesHard.get(index).getIsImageQuestion().equals("true")){
                // if is image
                Picasso.with(getBaseContext())
                        .load(ranListQuesHard.get(index).getQuestion())
                        .into(question_image);
                question_image.setVisibility(View.VISIBLE);
                question_text.setVisibility(View.INVISIBLE);
            }
            else{
                question_text.setText(ranListQuesHard.get(index).getQuestion());
            ...
            btnA.setText(ranListQuesHard.get(index).getAnswerA());
            btnB.setText(ranListQuesHard.get(index).getAnswerB());
            btnC.setText(ranListQuesHard.get(index).getAnswerC());
            btnD.setText(ranListQuesHard.get(index).getAnswerD());
    ...
    protected void onPostResume() {
        ...
        totalQuestion = Common.questionHardList.size();

        for(int i=0;i<totalQuestion;i++)
        {
            ranListQuesHard.add(Common.questionHardList.get(i));
        }

        Collections.shuffle(ranListQuesHard);
